...
| ------------ | ------------ | ------- |
| [Main from NateBJones-Projects:main](docs/ingestion-metadata-contract.md) | Main from NateBJones-Projects:main. | [@pull[bot]](https://github.com/pull[bot]) |
| [Main from NateBJones-Projects:main](docs/drafts) | Main from NateBJones-Projects:main. | [@pull[bot]](https://github.com/pull[bot]) |
